...
"""
# Task: Now that you know how to loop through a dictionary, clean up the code from Exercise 6-3 (page 99) by replacing your series of print() calls with a loop that runs through the dictionary’s keys and values. 
...
# A for loop is used to execute a set of code a number of times according to the conditions.
# In the given code the for loop is used to print the python terms individually.